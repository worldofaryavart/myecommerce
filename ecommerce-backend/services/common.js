...
let transporter = nodemailer.createTransport({
  ...
  auth: {
    user: 'factwiths@gmail.com', // gmail
...
exports.cookieExtractor = function (req) {
  ...
  token ="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY1YWE0YzA2OWE3NTE5MzM1MjAxOTA4ZSIsInJvbGUiOiJ1c2VyIiwiaWF0IjoxNzA1NzMzMTAzfQ.XJLZdIa8uGnrJUDfwBMuQoo_gY8E-yRfF_KTofwYbII"
  return token;
};
...
exports.sendMail = async function ({to, subject, text, html}){
    let info = await transporter.sendMail({
        from: '"E-commerce" <factwiths@gmail.com>', // sender address
        to,
        subject,
        text,
        html
